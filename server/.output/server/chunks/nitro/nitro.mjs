...
import { mkdirSync, promises, existsSync } from 'node:fs';
...
const _SAN7G6 = eventHandler((event) => {
...
const _lazy_XD21mC = () => import('../routes/api/auth/login.post.mjs');
const _lazy_f1w9Im = () => import('../routes/api/index.post.mjs');
const _lazy_Me7Sjj = () => import('../routes/api/form.get.mjs');
const _lazy_9j4ond = () => import('../routes/api/form.post.mjs');
const _lazy_kBZtVT = () => import('../routes/api/menu/menu.get.mjs');
const _lazy_BwWzaI = () => import('../routes/api/index.post2.mjs');
const _lazy_Tm4FON = () => import('../routes/api/test.mjs');
const _lazy_GIo87M = () => import('../routes/_..._.mjs');

const handlers = [
  { route: '', handler: _SAN7G6, lazy: false, middleware: true, method: undefined },
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/Users/lihaoran/ayu/web-build/server/.data/kv"}));
...
export { MOCK_USERS as M, db as a, mockFormData as b, mockTableData as c, defineEventHandler as d, getHeader as g, mockTableData2 as m, nodeServer as n, readBody as r, setResponseStatus as s };
